...
namespace ElasticSharp.Core.Algos
{
    ...
    public class Curve25519
    {
        ...
        public static bool isCanonicalSignature(byte[] v)
        {
            ...
            Buffer.BlockCopy(v, 0, vCopy, 0, 32);
            
            //java.util.Arrays.copyOfRange(v, 0, 32);
        ...
        public static int mula_small(byte[] p, byte[] q, int m, byte[] x, int n, int z)
        {
            int v = 0;
            for (int i = 0; i < n; ++i)
            {
        ...
        private static int P25 = 33554431;    /* (1 << 25) - 1 */
        private static int P26 = 67108863;    /* (1 << 26) - 1 */
        ...
        /* Copy a number */
        public static void cpy(Long10 outVal, Long10 inVal)
        {
            outVal._0 = inVal._0;
            outVal._1 = inVal._1;
            outVal._2 = inVal._2; outVal._3 = inVal._3;
            outVal._4 = inVal._4; outVal._5 = inVal._5;
            outVal._6 = inVal._6; outVal._7 = inVal._7;
            outVal._8 = inVal._8; outVal._9 = inVal._9;
        }

        /* Set a number to value, which must be in range -185861411 .. 185861411 */
        private static void set(Long10 outVal, int inVal)
        {
            outVal._0 = inVal;
            outVal._1 = 0;
            outVal._2 = 0; outVal._3 = 0;
            outVal._4 = 0; outVal._5 = 0;
            outVal._6 = 0; outVal._7 = 0;
            outVal._8 = 0; outVal._9 = 0;
        }
        ...
        private static readonly byte[] ORDER_TIMES_8 = {
        ...
        private static readonly Long10 BASE_2Y = new Long10(
            39999547, 18689728, 59995525, 1648697, 57546132,
                24010086, 19059592, 5425144, 63499247, 16420658
    );
        private static readonly Long10 BASE_R2Y = new Long10(
