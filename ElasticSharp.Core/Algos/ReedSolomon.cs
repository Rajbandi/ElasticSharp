...
{
    /// <summary>
    /// Direct port of java code from NXT source
    /// </summary>
    public class ReedSolomon
    {
        ...
        private static readonly int base_10_length = 20;
        ...
        class CodewordTooLongException : DecodeException
        {
        }

        class CodewordInvalidException :DecodeException
        {
        }
